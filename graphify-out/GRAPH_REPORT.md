...
## Corpus Check
- 804 files · ~2,076,899 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3735 nodes · 7981 edges · 170 communities detected
...
Cohesion: 0.01
Nodes (159): makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps(), installClickableVoteHandler() (+151 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (140): makeCtx(), makeRepo(), deleteClackMessage(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), buildSuccessResponse(), buildToolResults() (+132 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (160): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeConfigUpdateTool() (+152 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (149): loadConfig(), detectFollowUpCommand(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaude(), runClaudeInWorktree(), runWorktreeInstall() (+141 more)
...
Cohesion: 0.02
Nodes (74): checkSessionCompletion(), cleanupSession(), runCompletionCheck(), runIdleSweep(), makeDeps(), makeMockPool(), poolWorkerForChange(), fetchPRReviewContext() (+66 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (76): buildIntegrationsCatalog(), attentionLevelGuidance(), buildDeliveryContext(), buildPrompt(), formatThreadContext(), latestUserText(), messageClaimsAdmin(), renderAdminClaimContext() (+68 more)
...
Cohesion: 0.03
Nodes (39): completeSessionStart(), McpServerManager, deriveLocalPluginName(), installPluginInteractivity(), isPathEntry(), loadAndInstallPlugins(), loadLocalPluginModule(), loadPlugins() (+31 more)
...
Cohesion: 0.03
Nodes (50): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), recordError() (+42 more)
...
Cohesion: 0.03
Nodes (29): seedJob(), getCronMaxRunHistory(), assertValidJitter(), createJob(), deleteJob(), findByPluginOwner(), getEnabledJobs(), getFilePath() (+21 more)
...
Cohesion: 0.05
Nodes (38): createUsersSurface(), epochToIso(), fetchLastReply(), formatMessage(), resolveReplyUserName(), truncateText(), buildThreadMessage(), extractBlocksText() (+30 more)
...
Cohesion: 0.04
Nodes (28): askClaude(), buildPolicyBlock(), formatElapsedSeconds(), formatRelativeAge(), runActiveRunPreAnalysis(), runPreAnalysis(), captureSystemPrompt(), makeDeps() (+20 more)
...
- **Why does `tool()` connect `Community 2` to `Community 0`, `Community 8`, `Community 10`, `Community 20`, `Community 21`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 10`, `Community 17`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `McpServerManager` connect `Community 8` to `Community 1`, `Community 3`?**
