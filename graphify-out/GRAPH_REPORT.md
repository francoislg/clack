# Graph Report - claude-slack-bot  (2026-06-15)

## Corpus Check
- 836 files · ~2,108,143 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3848 nodes · 8226 edges · 166 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1332 edges (avg confidence: 0.8)
...
- `main()` --calls--> `loadConfig()`  [INFERRED]
  scripts/askClaudeWorktree.ts → src/plugins/idler/config.ts
- `main()` --calls--> `loadConfig()`  [INFERRED]
...
Cohesion: 0.01
Nodes (161): makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps(), installClickableVoteHandler() (+153 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (152): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+144 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (165): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), extractToolErrorMessage(), buildRosterBlock(), groupRosterAnswers(), renderHidden() (+157 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (139): readDataFile(), resolveDataPath(), validateConfigJson(), validateContent(), validateJson(), validateMcpJson(), writeDataFile(), resolveNonCollidingBranch() (+131 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (87): fetchAssistantContext(), resolveContextChannelId(), makeDeps(), makeStopDeps(), MockAssistant, enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext() (+79 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (80): buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), checkSessionCompletion(), cleanupSession(), runCompletionCheck(), runIdleSweep() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (104): loadConfig(), askClaude(), completeSessionStart(), McpServerManager, prepareMcpSession(), clackQuery(), buildSingleJudgePrompt(), judgeAnswer() (+96 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (71): resolveFallbackTopics(), textResult(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin() (+63 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (84): seedJob(), clearActiveChange(), getActiveChange(), makeCtx(), makeManager(), makeRegistry(), makeSession(), loadSession() (+76 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (47): detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), SilentDelivery, StreamingDelivery, setupDmDelivery(), buildDeliverFn() (+39 more)

### Community 10 - "Community 10"
Cohesion: 0.02
Nodes (41): makeHangingRun(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory(), recordTraceEntry(), summarizeContentBlocks() (+33 more)
...
Cohesion: 0.04
Nodes (46): convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), callTool(), callToolRaw() (+38 more)
...
Cohesion: 0.07
Nodes (38): actorDisplay(), actorDmTarget(), resolveJobActor(), makeChannellessChannelId(), circularRuns(), expandHourList(), formatDayOfWeekSuffix(), formatHour() (+30 more)
...
Cohesion: 0.06
Nodes (23): cleanupStaleSessionFolders(), createSessionFolder(), ensureSessionsDir(), getAllPersistedSessions(), getResumableSessions(), getSessionFolderPath(), isFolderOlderThan(), parseSessionState() (+15 more)
...
- **Thin community `Community 34`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 4`, `Community 7`, `Community 8`, `Community 13`, `Community 16`, `Community 17`, `Community 20`, `Community 23`, `Community 25`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 9`, `Community 13`, `Community 24`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Are the 130 inferred relationships involving `tool()` (e.g. with `pluginWithMixedTopics()` and `createAdminSetRoleTool()`) actually correct?**
  _`tool()` has 130 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 74 inferred relationships involving `t()` (e.g. with `handleMigrationFailure()` and `stampConfigUpdateLabels()`) actually correct?**
  _`t()` has 74 INFERRED edges - model-reasoned connections that need verification._
- **Are the 46 inferred relationships involving `errorMessage()` (e.g. with `ensureInstalled()` and `installAllPinnedMcpServers()`) actually correct?**
  _`errorMessage()` has 46 INFERRED edges - model-reasoned connections that need verification._