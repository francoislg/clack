# Graph Report - claude-slack-bot  (2026-06-29)

## Corpus Check
- 894 files · ~2,234,622 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4077 nodes · 8703 edges · 181 communities detected
...
Cohesion: 0.01
Nodes (202): createRemoveCheatTool(), createRetrieveScoresTool(), createSaveCheatingTool(), makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer() (+194 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (166): makeCtx(), makeRepo(), deleteClackMessage(), isProtectedBranchName(), isValidBranchName(), resolveNonCollidingBranch(), findChangeEnabledRepo(), getChangeEnabledRepos() (+158 more)
...
Cohesion: 0.02
Nodes (175): loadConfig(), getActiveChange(), detectFollowUpCommand(), drainStagedSpinoffs(), executeChange(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall() (+167 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (111): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), buildWorkerBashGuardHook(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage() (+103 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (86): asNumber(), readResultUsage(), appendAttachHistory(), makeCtx(), makeManager(), makeRegistry(), makeSession(), isKnownPublic() (+78 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (72): convertMarkdownToSlack(), splitForSlack(), SilentDelivery, StreamingDelivery, processMessage(), startThreadConversation(), deliverFollower(), postAnswerToChannel() (+64 more)
...
Cohesion: 0.02
Nodes (37): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), clearActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), checkSessionCompletion() (+29 more)
...
Cohesion: 0.04
Nodes (52): readRepoSkillBody(), discoverWorkerSkills(), getWorkerSkillMtimeMs(), listSlugs(), readDescription(), readWorkerSkillBody(), resolveSkillPath(), skillsRoots() (+44 more)
...
Cohesion: 0.04
Nodes (11): completeSessionStart(), McpServerManager, discoverEagerSkillPlugins(), discoverSkillPluginInfo(), discoverSkillPlugins(), resetSkillPluginsDeps(), safeSkillPluginsRegistry(), P() (+3 more)
...
Cohesion: 0.32
Nodes (5): registerChangeActionHandler(), makeApp(), makeClient(), makeHandlerArgs(), makeProposalMessage()
...
- **Why does `tool()` connect `Community 2` to `Community 0`, `Community 6`, `Community 9`, `Community 11`, `Community 17`, `Community 25`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `casualTalkPlugin()` connect `Community 2` to `Community 16`, `Community 1`, `Community 3`?**
