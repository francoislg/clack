...
## Corpus Check
- 740 files · ~1,902,103 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3499 nodes · 7427 edges · 168 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1181 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (144): makeCtx(), makeRepo(), deleteClackMessage(), findChangeEnabledRepo(), getChangeEnabledRepos(), buildSuccessResponse(), buildToolResults(), handleQueryError() (+136 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (136): detectFollowUpCommand(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), defaultGetReusablePool() (+128 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (136): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeConfigUpdateTool() (+128 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (106): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), buildCancelledResult(), handleFollowUp(), startChangeWorkflow(), ClaudeMessageParser (+98 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (74): readDataFile(), resolveDataPath(), validateConfigJson(), validateContent(), validateJson(), validateMcpJson(), writeDataFile(), askClaude() (+66 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (87): seedJob(), clearActiveChange(), getActiveChange(), callTool(), getSession(), readFile(), cacheFile(), extensionForMime() (+79 more)
...
Cohesion: 0.03
Nodes (78): classifySession(), markSessionFailed(), restoreWorkerSessions(), prepareMcpSession(), getLoadedPluginIntegrations(), defaultListPulls(), defaultGraphql(), createSlackApp() (+70 more)
...
Cohesion: 0.03
Nodes (40): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), checkSessionCompletion(), cleanupSession() (+32 more)

### Community 11 - "Community 11"
Cohesion: 0.02
Nodes (29): makeHangingRun(), createPushableAsyncIterable(), captureSessionId(), clackSession(), makeUserMessage(), createRunHandle(), makeDriver(), parseFrontmatter() (+21 more)
...
Cohesion: 0.04
Nodes (19): isKnownPublic(), isVisible(), loadSession(), matchesKeywords(), matchesType(), searchRecentInteractions(), summarize(), search() (+11 more)
...
- **Thin community `Community 38`** (7 nodes): `WorkerQueue`, `.depth()`, `.dequeue()`, `.enqueueAndWait()`, `.findBySession()`, `.list()`, `.removeEntry()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 7`, `Community 14`, `Community 17`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `tool()` connect `Community 3` to `Community 0`, `Community 34`, `Community 9`, `Community 14`, `Community 20`, `Community 21`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `ReusablePool` connect `Community 2` to `Community 1`?**
