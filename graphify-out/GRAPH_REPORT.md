...
## Corpus Check
- 701 files · ~1,739,380 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3350 nodes · 6914 edges · 166 communities detected
- Extraction: 83% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 976 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (146): createRetrieveScoresTool(), createSaveCheatingTool(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps() (+138 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (131): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+123 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (121): readDataFile(), resolveDataPath(), validateConfigJson(), validateContent(), validateJson(), validateMcpJson(), writeDataFile(), buildQuerySetup() (+113 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (72): fetchAssistantContext(), resolveContextChannelId(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), handleClassicDmEvent(), toClassicDmMessage() (+64 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (96): formatOwnerNotification(), truncate(), handleAutoExecuteActions(), handlePostToAutoExecute(), makeBaseParams(), makeClient(), registerChangeActionHandler(), makeApp() (+88 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (72): loadConfig(), makeHangingRun(), classifySession(), markSessionFailed(), restoreWorkerSessions(), buildSuccessResponse(), buildToolResults(), handleQueryError() (+64 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (75): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAnswerBlocks(), confirmInDm(), deliverFollower(), handleAcceptSynthesis(), handleEditSynthesis() (+67 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (56): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), detectFollowUpCommand(), findChangeEnabledRepo() (+48 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (49): checkSessionCompletion(), cleanupSession(), defaultGetReusablePool(), poolWorkerForChange(), runCompletionCheck(), runIdleSweep(), makeDeps(), makeMockPool() (+41 more)
...
Cohesion: 0.04
Nodes (57): appendAttachHistory(), createFindRecentInteractionsTool(), isKnownPublic(), isVisible(), loadSession(), matchesKeywords(), matchesType(), searchRecentInteractions() (+49 more)
...
Cohesion: 0.04
Nodes (16): loadKey(), parseFrontmatter(), prepareSkillsSession(), SkillsManager, makeConfig(), makeCtx(), makeSession(), flush() (+8 more)

### Community 18 - "Community 18"
Cohesion: 0.07
Nodes (37): createListUserSkillsTool(), call(), makeConfig(), makeCtx(), makeManager(), makePack(), makeSession(), setupUserSkillsTmp() (+29 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (21): buildDeliverFn(), buildDirectDeliverFn(), deliverViaStreamerOrFallback(), executeAndDeliver(), handleCancellation(), handleError(), handleSkip(), handleSuccess() (+13 more)
...
Cohesion: 0.1
Nodes (29): isRevealResponsesMode(), parseTriviaAxisBag(), validateAllTimeRowMode(), validateAnswersFormatMap(), validateContextsList(), validateDifficultyBucketWeights(), validateDifficultyRange(), validateDifficultyRangesMap() (+21 more)
...
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 6`, `Community 7`, `Community 15`, `Community 19`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `ReusablePool` connect `Community 8` to `Community 1`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 2` to `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 12`, `Community 13`, `Community 15`, `Community 17`, `Community 18`, `Community 31`?**
