# Graph Report - claude-slack-bot  (2026-06-12)

## Corpus Check
- 800 files · ~2,055,333 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3708 nodes · 7912 edges · 169 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1266 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (158): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+150 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (171): executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), checkSessionCompletion(), cleanupSession() (+163 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (105): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), classifySession(), markSessionFailed() (+97 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (119): loadConfig(), completeSessionStart(), McpServerManager, prepareMcpSession(), addMigrationError(), dmAdmin(), getAdmin(), handleMigrationFailure() (+111 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (66): truncate(), runClaude(), makeHangingRun(), askClaude(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty() (+58 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (65): enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient(), makeConfig() (+57 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (50): detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), SilentDelivery, StreamingDelivery, buildTriggerFromParams(), processMessage() (+42 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (67): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), recordError() (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (76): formatOwnerNotification(), buildHintModal(), buildFreeformModal(), escapeMarkdown(), buildAnswerBlocks(), confirmInDm(), handleAcceptSynthesis(), handleEditSynthesis() (+68 more)
...
Cohesion: 0.06
Nodes (56): isRevealResponsesMode(), normalizeChoices(), normalizeDifficultyPerFormat(), normalizeHint(), normalizeRangesMap(), normalizeRatioPerFormat(), parseTriviaAxisBag(), validateAllTimeRowMode() (+48 more)
...
Cohesion: 0.05
Nodes (34): publishHomeView(), registerAddRoleHandlers(), registerHomeTabHandler(), registerRemoveRoleHandlers(), makeApp(), refreshHomeView(), cacheFile(), extensionForMime() (+26 more)
...
Cohesion: 0.09
Nodes (34): makeConfig(), makeCtx(), makeManager(), makePack(), makeSession(), setupUserSkillsTmp(), teardownUserSkillsTmp(), disableUserSkill() (+26 more)

### Community 20 - "Community 20"
Cohesion: 0.07
Nodes (22): cleanupStaleSessionFolders(), createSessionFolder(), ensureSessionsDir(), getAllPersistedSessions(), getResumableSessions(), getSessionFolderPath(), isFolderOlderThan(), parseSessionState() (+14 more)
...
- **Thin community `Community 31`** (12 nodes): `detachStub()`, `failingRelease()`, `makeActiveChange()`, `makeDeps()`, `makeFakeHandle()`, `makeMockPool()`, `makeSweepPool()`, `makeWorker()`, `makeWorkerRecord()`, `mockRelease()`, `sessionReturning()`, `monitor.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 37`** (7 nodes): `buildConfigPath()`, `buildInstructionPath()`, `refineConfigTarget()`, `validateConfigTarget()`, `repoInstructionFiles.ts`, `configFieldSchemas.test.ts`, `configFieldSchemas.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 74`** (2 nodes): `Clack Tools Delta Specification (cancellation)`, `Cancel Worker Run Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `Clack Tools Delta Specification (delete message)`, `Admin Delete Message Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 34`, `Community 3`, `Community 6`, `Community 8`, `Community 17`, `Community 18`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 9` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Are the 113 inferred relationships involving `tool()` (e.g. with `pluginWithMixedTopics()` and `createAdminSetRoleTool()`) actually correct?**
  _`tool()` has 113 INFERRED edges - model-reasoned connections that need verification._
- **Are the 84 inferred relationships involving `resolve()` (e.g. with `loadConfigForManifest()` and `main()`) actually correct?**
  _`resolve()` has 84 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 71 inferred relationships involving `t()` (e.g. with `handleMigrationFailure()` and `stampConfigUpdateLabels()`) actually correct?**
