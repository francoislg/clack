...
## Corpus Check
- 784 files · ~2,043,086 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3656 nodes · 7826 edges · 176 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1253 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (129): makeCtx(), makeRepo(), deleteClackMessage(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), hasProperty(), recordTraceEntry() (+121 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (211): loadConfig(), detectFollowUpCommand(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup() (+203 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (122): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks() (+114 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (137): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeConfigUpdateTool() (+129 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (74): textResult(), convertMarkdownToSlack(), splitForSlack(), buildSuccessResponse(), buildToolResults(), handleQueryError(), optionalHistory(), buildIntegrationsCatalog() (+66 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (71): seedJob(), resolveAutoRespondContext(), respond(), processMessage(), startThreadConversation(), fetchViaHistory(), fetchViaReplies(), resolveReactedMessage() (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (38): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool() (+30 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (43): makeHangingRun(), askClaude(), buildPolicyBlock(), formatElapsedSeconds(), formatRelativeAge(), runActiveRunPreAnalysis(), runPreAnalysis(), captureSystemPrompt() (+35 more)
...
Cohesion: 0.04
Nodes (45): clearActiveChange(), getActiveChange(), callTool(), readFile(), cacheFile(), extensionForMime(), filePath(), getCachedFile() (+37 more)
...
- **Thin community `Community 33`** (13 nodes): `makeCtx()`, `makeUsersCache()`, `resetMocks()`, `createUsersCache()`, `isRealUser()`, `makeClient()`, `toUserEntry()`, `buildWildcardMatcher()`, `usersCache.test.ts`, `usersCache.ts`, `wildcardMatcher.test.ts`, `wildcardMatcher.ts`, `findUser.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 51`** (5 nodes): `makeCtx()`, `makeDeps()`, `makeRepo()`, `makeWorker()`, `findChanges.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 55`** (5 nodes): `reusablePool.test.ts`, `makeFakeGit()`, `makePool()`, `makeRepo()`, `poolWithMissingIdleWorker()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 4` to `Community 0`, `Community 5`, `Community 7`, `Community 39`, `Community 16`, `Community 22`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.020) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 5`, `Community 23`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 2` to `Community 1`, `Community 3`, `Community 36`, `Community 5`, `Community 6`, `Community 9`, `Community 11`, `Community 13`, `Community 15`, `Community 18`, `Community 21`?**
