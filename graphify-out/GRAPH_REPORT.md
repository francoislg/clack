...
## Corpus Check
- 892 files · ~2,215,979 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4065 nodes · 8680 edges · 172 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1413 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (233): createCreateScheduledMessageTool(), createUpdateScheduledMessageTool(), formatOwnerNotification(), truncate(), buildHintModal(), isChangesEnabledForTrigger(), extractToolErrorMessage(), NullDelivery (+225 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (175): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx(), makeRepo() (+167 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (230): loadConfig(), isProtectedBranchName(), isValidBranchName(), resolveNonCollidingBranch(), detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), drainStagedSpinoffs() (+222 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (93): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool() (+85 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (117): seedJob(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient() (+109 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (51): makeHangingRun(), makeRunFromMessages(), askClaude(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory() (+43 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (52): resolveFallbackTopics(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin(), buildSdk() (+44 more)

### Community 8 - "Community 8"
Cohesion: 0.04
Nodes (51): textResult(), convertMarkdownToSlack(), splitForSlack(), textResult(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool() (+43 more)
...
Cohesion: 0.06
Nodes (29): buildTrackedMemoryKinds(), listTrackedKinds(), namespaceOf(), trackedMemoryKindsForRole(), fakeClackQuery(), makeSdk(), scriptedQueryResult(), archive() (+21 more)
...
Cohesion: 0.07
Nodes (20): ClaudeMessageParser, detectPlatformError(), joinContentBlocks(), stringifyToolResultContent(), asNumber(), readResultUsage(), createFindRecentInteractionsTool(), isKnownPublic() (+12 more)
...
- **Thin community `Community 38`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (5 nodes): `toolNameValidator.test.ts`, `discoverRegisteredCoreToolNames()`, `stubPlugin()`, `stubRegisteredTool()`, `walk()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 70`** (2 nodes): `Lazy Skill Loading Feature`, `OpenSpec: Add Lazy Skill Loading`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 71`** (2 nodes): `Error Reporting and Tool Context`, `Session Management - Tool Call History`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 72`** (2 nodes): `Simplified Orchestrator Pattern`, `Worker Tools (MCP-Based Infrastructure)`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 73`** (2 nodes): `Session auto-cleanup notification removal`, `Completion monitor`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 74`** (2 nodes): `Send to Thread Content`, `Unified Response Delivery`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 75`** (2 nodes): `Slack File Attachments`, `Slack Image Support`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 76`** (2 nodes): `Clack Tools Delta Specification (admin-set-role)`, `Admin Set Role Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 77`** (2 nodes): `Clack Tools Delta Specification (cancellation)`, `Cancel Worker Run Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 79`** (2 nodes): `Clack Tools Delta Specification (delete message)`, `Admin Delete Message Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 80`** (2 nodes): `Channel Context Delta Specification (reactions)`, `Message Reactions Context Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (2 nodes): `Clack Plugins Specification`, `Trivia Instruction Tools Change`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 82`** (2 nodes): `Channel Context Specification`, `Harden Fetch Channel Messages Change`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 83`** (2 nodes): `Pin MCP Installs Change`, `Pinned MCP Installs Specification`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 84`** (2 nodes): `Slack File Attachments Specification`, `Slack Image Support Specification`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 85`** (2 nodes): `Trivia Batch Answers Specification`, `Trivia Categories Specification`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 86`** (2 nodes): `Trivia Cheating Detection Specification`, `Trivia Question Search Specification`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 2` to `Community 0`, `Community 1`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 12`, `Community 16`, `Community 20`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.026) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 1` to `Community 0`, `Community 8`, `Community 3`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 3` to `Community 1`, `Community 34`, `Community 2`, `Community 4`, `Community 5`, `Community 12`, `Community 14`, `Community 15`, `Community 18`?**
