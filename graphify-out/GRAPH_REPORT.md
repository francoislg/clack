...
## Corpus Check
- 836 files · ~2,107,823 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3846 nodes · 8222 edges · 180 communities detected
...
Cohesion: 0.01
Nodes (191): createRemoveCheatTool(), createRetrieveScoresTool(), createSaveCheatingTool(), makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer() (+183 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (157): makeCtx(), makeRepo(), makeActiveChange(), makeCtx(), deleteClackMessage(), buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl() (+149 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (157): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeConfigUpdateTool() (+149 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (169): detectFollowUpCommand(), drainStagedSpinoffs(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup() (+161 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (103): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks() (+95 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (81): textResult(), convertMarkdownToSlack(), splitForSlack(), buildSuccessResponse(), buildToolResults(), handleQueryError(), optionalHistory(), SilentDelivery (+73 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (69): enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient(), makeConfig() (+61 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (32): makeHangingRun(), createPushableAsyncIterable(), captureSessionId(), clackQuery(), clackSession(), makeUserMessage(), createRunHandle(), makeDriver() (+24 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (68): loadConfig(), askClaude(), prepareMcpSession(), testMCP(), analyzeError(), detectRuntime(), summarizeForSlack(), buildSingleJudgePrompt() (+60 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (56): seedJob(), actorDisplay(), actorDmTarget(), resolveJobActor(), makeChannellessChannelId(), getCronMaxRunHistory(), circularRuns(), expandHourList() (+48 more)
...
Cohesion: 0.06
Nodes (42): registerSkillActionHandler(), button(), invoke(), makeBody(), makeClient(), makeMockApp(), makePostMock(), call() (+34 more)
...
Cohesion: 0.05
Nodes (23): buildQuerySetup(), wrapDeliverWithDeliveredMark(), buildIntegrationsCatalog(), completeSessionStart(), McpServerManager, attentionLevelGuidance(), buildDeliveryContext(), buildPrompt() (+15 more)
...
Cohesion: 0.13
Nodes (30): clearActiveChange(), getActiveChange(), cacheFile(), extensionForMime(), filePath(), getCachedFile(), getCacheDir(), metaPath() (+22 more)
...
Cohesion: 0.17
Nodes (2): lockableQuestion(), postedQuestion()
...
- **Thin community `Community 28`** (13 nodes): `blockIds()`, `booleanQuestion()`, `booleanRow()`, `choiceQuestion()`, `choiceRow()`, `fakeClient()`, `freeformQuestion()`, `freeformRow()`, `lockableQuestion()`, `postedQuestion()`, `rosterText()`, `tagRef()`, `roster.test.ts`
...
- **Thin community `Community 35`** (12 nodes): `detachStub()`, `failingRelease()`, `makeActiveChange()`, `makeDeps()`, `makeFakeHandle()`, `makeMockPool()`, `makeSweepPool()`, `makeWorker()`, `makeWorkerRecord()`, `mockRelease()`, `sessionReturning()`, `monitor.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 43`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 46`** (7 nodes): `WorkerQueue`, `.depth()`, `.dequeue()`, `.enqueueAndWait()`, `.findBySession()`, `.list()`, `.removeEntry()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 58`** (5 nodes): `makeCtx()`, `makeDeps()`, `makeRepo()`, `makeSession()`, `findSessions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 96`** (2 nodes): `Clack Tools Delta Specification (cancellation)`, `Cancel Worker Run Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 97`** (2 nodes): `Admin Delete Message Specification`, `Admin Delete Message Design Document`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 98`** (2 nodes): `Clack Tools Delta Specification (delete message)`, `Admin Delete Message Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 2` to `Community 0`, `Community 5`, `Community 40`, `Community 15`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 6`, `Community 14`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `ReusablePool` connect `Community 3` to `Community 1`?**
