...
## Corpus Check
- 846 files · ~2,125,289 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3880 nodes · 8305 edges · 178 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1353 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (195): createRemoveCheatTool(), createRetrieveScoresTool(), createSaveCheatingTool(), makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer() (+187 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (209): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+201 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (236): loadConfig(), getActiveChange(), detectFollowUpCommand(), drainStagedSpinoffs(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaude() (+228 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (110): formatOwnerNotification(), truncate(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks(), stringifyToolResultContent(), buildPolicyBlock() (+102 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (82): appendAttachHistory(), makeCtx(), makeManager(), makeRegistry(), makeSession(), isKnownPublic(), isVisible(), loadSession() (+74 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (80): seedJob(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient() (+72 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (58): resolveFallbackTopics(), textResult(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin() (+50 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (44): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), clearActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps() (+36 more)
...
Cohesion: 0.03
Nodes (23): makeHangingRun(), createPushableAsyncIterable(), captureSessionId(), clackSession(), makeUserMessage(), createRunHandle(), makeDriver(), makeClient() (+15 more)
...
Cohesion: 0.04
Nodes (53): discoverWorkerSkills(), getWorkerSkillMtimeMs(), listSlugs(), readDescription(), readWorkerSkillBody(), resolveSkillPath(), skillsRoots(), getWorkerSkillBody() (+45 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (44): createClackSdk(), makeSdk(), fakeClackQuery(), makeSdk(), scriptedQueryResult(), createUsersSurface(), epochToIso(), fetchLastReply() (+36 more)
...
Cohesion: 0.05
Nodes (41): readDataFile(), resolveDataPath(), validateConfigJson(), validateContent(), validateJson(), validateMcpJson(), writeDataFile(), buildIntegrationsCatalog() (+33 more)
...
Cohesion: 0.2
Nodes (3): callTool(), makeCtx(), makeRepo()
...
- **Thin community `Community 51`** (5 nodes): `makeCtx()`, `makeDeps()`, `makeRepo()`, `makeWorker()`, `findChanges.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 53`** (5 nodes): `makeCtx()`, `makeDeps()`, `makeRepo()`, `makeSession()`, `findSessions.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 87`** (2 nodes): `Clack Tools Delta Specification (cancellation)`, `Cancel Worker Run Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 88`** (2 nodes): `Admin Delete Message Specification`, `Admin Delete Message Design Document`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 89`** (2 nodes): `Clack Tools Delta Specification (delete message)`, `Admin Delete Message Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 38`, `Community 7`, `Community 6`, `Community 11`, `Community 17`, `Community 22`, `Community 23`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 3` to `Community 0`, `Community 1`, `Community 2`, `Community 11`, `Community 21`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 2` to `Community 33`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 8`, `Community 12`, `Community 13`, `Community 16`?**
