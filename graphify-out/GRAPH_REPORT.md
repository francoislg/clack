...
## Corpus Check
- 752 files · ~1,950,427 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3544 nodes · 7549 edges · 169 communities detected
...
Cohesion: 0.01
Nodes (153): assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps(), installClickableVoteHandler(), fakeSdk() (+145 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (149): makeCtx(), makeRepo(), deleteClackMessage(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), buildSuccessResponse(), buildToolResults() (+141 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (158): detectFollowUpCommand(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), checkSessionCompletion() (+150 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (145): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeSkillCreateTool() (+137 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (92): completeSessionStart(), McpServerManager, prepareMcpSession(), deriveLocalPluginName(), installPluginInteractivity(), isPathEntry(), loadAndInstallPlugins(), loadLocalPluginModule() (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (72): readDataFile(), resolveDataPath(), validateConfigJson(), validateContent(), validateJson(), validateMcpJson(), writeDataFile(), buildIntegrationsCatalog() (+64 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (56): loadConfig(), clackQuery(), setupDmDelivery(), buildTestTasks(), cleanup(), main(), parallel(), readTestConfig() (+48 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (95): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks() (+87 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (37): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps() (+29 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (54): seedJob(), actorDisplay(), actorDmTarget(), resolveJobActor(), makeChannellessChannelId(), getCronMaxRunHistory(), formatDayOfWeekSuffix(), formatHour() (+46 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (49): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), recordError() (+41 more)
...
Cohesion: 0.04
Nodes (21): makeHangingRun(), createPushableAsyncIterable(), captureSessionId(), clackSession(), makeUserMessage(), createRunHandle(), makeDriver(), call() (+13 more)
...
Cohesion: 0.04
Nodes (27): publishHomeView(), registerAddRoleHandlers(), registerHomeTabHandler(), registerRemoveRoleHandlers(), makeApp(), closeModalIfOpen(), extractViewId(), refreshHomeView() (+19 more)

### Community 17 - "Community 17"
Cohesion: 0.05
Nodes (10): searchRecentInteractions(), search(), discoverEagerSkillPlugins(), discoverSkillPluginInfo(), discoverSkillPlugins(), resetSkillPluginsDeps(), safeSkillPluginsRegistry(), P() (+2 more)

### Community 18 - "Community 18"
Cohesion: 0.09
Nodes (36): clearActiveChange(), callTool(), readFile(), cacheFile(), extensionForMime(), filePath(), getCachedFile(), getCacheDir() (+28 more)

### Community 19 - "Community 19"
Cohesion: 0.07
Nodes (18): epochToIso(), fetchLastReply(), formatMessage(), resolveReplyUserName(), truncateText(), buildThreadMessage(), extractBlocksText(), extractMessageText() (+10 more)
...
- **Thin community `Community 39`** (7 nodes): `WorkerQueue`, `.depth()`, `.dequeue()`, `.enqueueAndWait()`, `.findBySession()`, `.list()`, `.removeEntry()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 3` to `Community 0`, `Community 36`, `Community 8`, `Community 10`, `Community 21`, `Community 22`, `Community 23`, `Community 28`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 6`, `Community 10`, `Community 16`, `Community 24`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 2` to `Community 33`, `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 15`, `Community 16`, `Community 17`, `Community 18`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
