...
## Corpus Check
- 707 files · ~1,761,302 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3365 nodes · 6951 edges · 163 communities detected
...
Cohesion: 0.01
Nodes (142): createRetrieveScoresTool(), createSaveCheatingTool(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps() (+134 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (110): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+102 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (129): executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), checkSessionCompletion(), cleanupSession() (+121 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (102): fetchAssistantContext(), resolveContextChannelId(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), triggerChangeWorkflow(), handleClassicDmEvent() (+94 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (93): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks() (+85 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (70): detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory() (+62 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (71): readDataFile(), resolveDataPath(), validateConfigJson(), validateContent(), validateJson(), validateMcpJson(), writeDataFile(), buildQuerySetup() (+63 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (79): textResult(), convertMarkdownToSlack(), splitForSlack(), processMessage(), buildAnswerBlocks(), confirmInDm(), deliverFollower(), handleAcceptSynthesis() (+71 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (89): prepareMcpSession(), deriveLocalPluginName(), installPluginInteractivity(), isPathEntry(), loadAndInstallPlugins(), loadLocalPluginModule(), loadPlugins(), synthesizeErrorResult() (+81 more)
...
Cohesion: 0.03
Nodes (68): createReadErrorReportTool(), callHandler(), appendAttachHistory(), createFindRecentInteractionsTool(), isKnownPublic(), isVisible(), loadSession(), matchesKeywords() (+60 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (33): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool() (+25 more)
...
Cohesion: 0.05
Nodes (19): makeHangingRun(), createPushableAsyncIterable(), captureSessionId(), clackSession(), makeUserMessage(), createRunHandle(), makeDriver(), call() (+11 more)
...
- **Thin community `Community 67`** (2 nodes): `Clack Tools Delta Specification (cancellation)`, `Cancel Worker Run Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 68`** (2 nodes): `Clack Tools Delta Specification (delete message)`, `Admin Delete Message Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 14`?**
