...
## Corpus Check
- 828 files · ~2,091,490 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3817 nodes · 8140 edges · 164 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1321 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (155): makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps(), installClickableVoteHandler() (+147 more)
...
Cohesion: 0.01
Nodes (112): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeHangingRun(), classifySession() (+104 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (130): executeChange(), readBranchHead(), resolveChangesInstructions(), runClaude(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), defaultGetReusablePool() (+122 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (117): loadConfig(), prepareMcpSession(), loadConfig(), addMigrationError(), dmAdmin(), getAdmin(), handleMigrationFailure(), runBlockingMigrations() (+109 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (64): checkSessionCompletion(), cleanupSession(), runCompletionCheck(), runIdleSweep(), makeDeps(), makeMockPool(), poolWorkerForChange(), fetchPRReviewContext() (+56 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (77): fetchAssistantContext(), resolveContextChannelId(), makeDeps(), makeStopDeps(), MockAssistant, enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext() (+69 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (111): formatOwnerNotification(), truncate(), buildHintModal(), extractToolErrorMessage(), buildRosterBlock(), groupRosterAnswers(), renderHidden(), applyConfigUpdateIntent() (+103 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (88): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAnswerBlocks(), confirmInDm(), deliverFollower(), handleAcceptSynthesis(), handleEditSynthesis() (+80 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (50): resolveFallbackTopics(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin(), buildSdk() (+42 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (39): detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), ClaudeMessageParser, detectPlatformError(), joinContentBlocks(), stringifyToolResultContent() (+31 more)
...
Cohesion: 0.03
Nodes (35): askClaude(), buildPolicyBlock(), formatElapsedSeconds(), formatRelativeAge(), runActiveRunPreAnalysis(), runPreAnalysis(), captureSystemPrompt(), makeDeps() (+27 more)
...
Cohesion: 0.06
Nodes (39): createFindRecentInteractionsTool(), isKnownPublic(), isVisible(), matchesKeywords(), matchesType(), searchRecentInteractions(), summarize(), search() (+31 more)
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 2`, `Community 6`, `Community 8`, `Community 9`, `Community 17`, `Community 18`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.023) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 7` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`?**
  _High betweenness centrality (0.018) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 3` to `Community 2`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 11`, `Community 13`, `Community 15`, `Community 17`, `Community 19`, `Community 22`, `Community 29`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Are the 127 inferred relationships involving `tool()` (e.g. with `pluginWithMixedTopics()` and `createAdminSetRoleTool()`) actually correct?**
  _`tool()` has 127 INFERRED edges - model-reasoned connections that need verification._
...
- **Are the 73 inferred relationships involving `t()` (e.g. with `handleMigrationFailure()` and `stampConfigUpdateLabels()`) actually correct?**
