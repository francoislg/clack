# Graph Report - claude-slack-bot  (2026-06-10)

## Corpus Check
- 761 files · ~1,984,221 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3587 nodes · 7634 edges · 170 communities detected
...
Cohesion: 0.01
Nodes (108): makeCtx(), makeRepo(), deleteClackMessage(), detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), fetchPRReviewContext() (+100 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (175): executeChange(), readBranchHead(), resolveChangesInstructions(), runClaude(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), checkSessionCompletion() (+167 more)
...
Cohesion: 0.02
Nodes (78): loadConfig(), askClaude(), prepareMcpSession(), buildPolicyBlock(), formatElapsedSeconds(), formatRelativeAge(), runActiveRunPreAnalysis(), runPreAnalysis() (+70 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (122): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeConfigUpdateTool() (+114 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (72): appendAttachHistory(), isKnownPublic(), isVisible(), loadSession(), matchesKeywords(), matchesType(), searchRecentInteractions(), summarize() (+64 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (84): formatOwnerNotification(), truncate(), buildHintModal(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks(), stringifyToolResultContent() (+76 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (67): textResult(), convertMarkdownToSlack(), splitForSlack(), SilentDelivery, StreamingDelivery, deliverFollower(), postAnswerToChannel(), applyDeliveryReactions() (+59 more)

### Community 9 - "Community 9"
Cohesion: 0.03
Nodes (67): seedJob(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), processMessage(), startThreadConversation(), getChannelInfo() (+59 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (47): resolveFallbackTopics(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin(), buildSdk() (+39 more)

### Community 11 - "Community 11"
Cohesion: 0.03
Nodes (41): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus() (+33 more)
...
Cohesion: 0.04
Nodes (20): makeHangingRun(), createRunHandle(), makeDriver(), call(), clientWithReplies(), makeClient(), makeConfig(), makeClient() (+12 more)
...
Cohesion: 0.07
Nodes (21): epochToIso(), fetchLastReply(), formatMessage(), resolveReplyUserName(), truncateText(), buildThreadMessage(), extractBlocksText(), extractMessageText() (+13 more)
...
Cohesion: 0.08
Nodes (8): discoverEagerSkillPlugins(), discoverSkillPluginInfo(), discoverSkillPlugins(), resetSkillPluginsDeps(), safeSkillPluginsRegistry(), P(), resetMocks(), setupTwoPlugins()
...
- **Thin community `Community 80`** (2 nodes): `Admin Delete Message Specification`, `Admin Delete Message Design Document`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 81`** (2 nodes): `Clack Tools Delta Specification (delete message)`, `Admin Delete Message Proposal`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 5` to `Community 0`, `Community 38`, `Community 8`, `Community 10`, `Community 11`, `Community 23`, `Community 25`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 2` to `Community 1`, `Community 35`, `Community 4`, `Community 3`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 12`, `Community 17`, `Community 22`?**
