...
## Corpus Check
- 898 files · ~2,263,318 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4092 nodes · 8747 edges · 177 communities detected
...
Cohesion: 0.01
Nodes (133): makeCtx(), makeRepo(), deleteClackMessage(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), buildSuccessResponse(), buildToolResults() (+125 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (186): getActiveChange(), isProtectedBranchName(), isValidBranchName(), detectFollowUpCommand(), drainStagedSpinoffs(), executeChange(), readBranchHead(), resolveChangesInstructions() (+178 more)
...
Cohesion: 0.02
Nodes (96): formatOwnerNotification(), truncate(), buildHintModal(), resolveNonCollidingBranch(), runClaude(), buildWorkerBashGuardHook(), ClaudeMessageParser, detectPlatformError() (+88 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (45): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool() (+37 more)
...
Cohesion: 0.03
Nodes (72): loadConfig(), prepareMcpSession(), clackQuery(), SilentDelivery, StreamingDelivery, setupDmDelivery(), loadConfig(), buildTestTasks() (+64 more)
...
Cohesion: 0.03
Nodes (52): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), recordError() (+44 more)
...
Cohesion: 0.03
Nodes (34): makeHangingRun(), makeRunFromMessages(), askClaude(), buildPolicyBlock(), formatElapsedSeconds(), formatRelativeAge(), runActiveRunPreAnalysis(), runPreAnalysis() (+26 more)
...
Cohesion: 0.05
Nodes (47): buildIntegrationsCatalog(), attentionLevelGuidance(), buildDeliveryContext(), buildPrompt(), formatThreadContext(), latestUserText(), messageClaimsAdmin(), renderAdminClaimContext() (+39 more)
...
Cohesion: 0.06
Nodes (15): getByThread(), getForChannelMessage(), makeThreadKey(), register(), withThreadLock(), dispatchAction(), dispatchView(), findActionHandler() (+7 more)
...
- **Thin community `Community 46`** (6 nodes): `appendActivity()`, `clearActivity()`, `loadActivity()`, `fakeSdk()`, `activity.test.ts`, `activity.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 54`** (5 nodes): `NullDelivery`, `.deliver()`, `.handleEvent()`, `.windDown()`, `.windUp()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 3` to `Community 0`, `Community 33`, `Community 9`, `Community 10`, `Community 18`, `Community 28`, `Community 29`, `Community 31`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 1`, `Community 2`, `Community 7`, `Community 9`, `Community 16`, `Community 20`, `Community 27`?**
