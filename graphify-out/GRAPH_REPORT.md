...
## Corpus Check
- 802 files · ~2,064,345 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3726 nodes · 7962 edges · 168 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1279 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (137): makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps(), installClickableVoteHandler() (+129 more)
...
Cohesion: 0.02
Nodes (156): executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), checkSessionCompletion(), cleanupSession() (+148 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (108): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool() (+100 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (156): formatOwnerNotification(), buildHintModal(), parseMessageCoordinates(), textResult(), convertMarkdownToSlack(), splitForSlack(), buildLockedNotice(), buildRosterBlock() (+148 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (124): loadConfig(), askClaude(), completeSessionStart(), McpServerManager, prepareMcpSession(), clackQuery(), testMCP(), analyzeError() (+116 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (87): enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient(), makeConfig() (+79 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (54): truncate(), runClaude(), makeHangingRun(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory() (+46 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (69): seedJob(), actorDisplay(), actorDmTarget(), resolveJobActor(), makeChannellessChannelId(), getCronMaxRunHistory(), getTaskCardMaxDetails(), formatDayOfWeekSuffix() (+61 more)
...
Cohesion: 0.03
Nodes (42): applyConfigUpdateIntent(), registerConfigUpdateActionHandler(), captureHandler(), makeClient(), makeDeps(), makeHandlerArgs(), publishHomeView(), registerAddRoleHandlers() (+34 more)

### Community 11 - "Community 11"
Cohesion: 0.04
Nodes (32): detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), SilentDelivery, StreamingDelivery, applyDeliveryReactions(), buildDeliverFn() (+24 more)
...
Cohesion: 0.07
Nodes (40): registerSkillActionHandler(), invoke(), makeBody(), makeClient(), makeMockApp(), makePostMock(), makeConfig(), makeCtx() (+32 more)
...
- **Thin community `Community 36`** (7 nodes): `buildConfigPath()`, `buildInstructionPath()`, `refineConfigTarget()`, `validateConfigTarget()`, `repoInstructionFiles.ts`, `configFieldSchemas.test.ts`, `configFieldSchemas.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 6`, `Community 15`, `Community 18`, `Community 22`, `Community 24`?**
  _High betweenness centrality (0.022) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 10`, `Community 11`?**
...
- **Are the 45 inferred relationships involving `errorMessage()` (e.g. with `ensureInstalled()` and `installAllPinnedMcpServers()`) actually correct?**
  _`errorMessage()` has 45 INFERRED edges - model-reasoned connections that need verification._