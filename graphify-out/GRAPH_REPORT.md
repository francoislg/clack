...
## Corpus Check
- 835 files · ~2,107,547 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3843 nodes · 8210 edges · 170 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1328 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (193): createRemoveCheatTool(), createRetrieveScoresTool(), createSaveCheatingTool(), makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer() (+185 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (148): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+140 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (171): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks() (+163 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (183): loadConfig(), resolveNonCollidingBranch(), detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), drainStagedSpinoffs(), executeChange() (+175 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (69): checkSessionCompletion(), cleanupSession(), runCompletionCheck(), runIdleSweep(), makeDeps(), makeMockPool(), poolWorkerForChange(), fetchPRReviewContext() (+61 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (54): makeHangingRun(), askClaude(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory(), recordTraceEntry() (+46 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (81): clearActiveChange(), getActiveChange(), claimSession(), makeSession(), appendAttachHistory(), makeCtx(), makeManager(), makeRegistry() (+73 more)
...
Cohesion: 0.03
Nodes (58): enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient(), makeConfig() (+50 more)
...
Cohesion: 0.04
Nodes (47): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), recordError() (+39 more)

### Community 12 - "Community 12"
Cohesion: 0.04
Nodes (58): seedJob(), actorDisplay(), actorDmTarget(), resolveJobActor(), makeChannellessChannelId(), getCronMaxRunHistory(), circularRuns(), expandHourList() (+50 more)

### Community 13 - "Community 13"
Cohesion: 0.04
Nodes (44): makeBaseParams(), makeClient(), registerConfigUpdateActionHandler(), captureHandler(), makeClient(), makeConfigMessage(), makeDeps(), makeHandlerArgs() (+36 more)

### Community 14 - "Community 14"
Cohesion: 0.03
Nodes (15): buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), buildMockPool(), depsWithPool(), failedSession(), makeActiveChangeState() (+7 more)
...
- **Thin community `Community 37`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 38`** (7 nodes): `buildConfigPath()`, `buildInstructionPath()`, `refineConfigTarget()`, `validateConfigTarget()`, `repoInstructionFiles.ts`, `configFieldSchemas.test.ts`, `configFieldSchemas.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 7`, `Community 11`, `Community 18`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.019) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 11`, `Community 13`?**
  _High betweenness centrality (0.014) - this node is a cross-community bridge._
- **Why does `SkillsManager` connect `Community 29` to `Community 3`?**
  _High betweenness centrality (0.011) - this node is a cross-community bridge._
- **Are the 128 inferred relationships involving `tool()` (e.g. with `pluginWithMixedTopics()` and `createAdminSetRoleTool()`) actually correct?**
  _`tool()` has 128 INFERRED edges - model-reasoned connections that need verification._
