...
## Corpus Check
- 696 files · ~1,732,737 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3334 nodes · 6884 edges · 168 communities detected
- Extraction: 83% EXTRACTED · 14% INFERRED · 0% AMBIGUOUS · INFERRED: 971 edges (avg confidence: 0.8)
...
- `substituteEnvVars()` --calls--> `resolve()`  [INFERRED]
  scripts/dump-mcp-tools.ts → src/streaming/toolLabels.ts
- `runFullPathTest()` --calls--> `getPendingMigrations()`  [INFERRED]
...
Cohesion: 0.01
Nodes (181): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeSkillCreateTool() (+173 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (135): createRetrieveScoresTool(), createSaveCheatingTool(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps() (+127 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (96): executeChange(), readBranchHead(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), checkSessionCompletion(), cleanupSession() (+88 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (95): seedJob(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient() (+87 more)
...
Cohesion: 0.02
Nodes (71): truncate(), loadConfig(), runClaude(), makeHangingRun(), askClaude(), completeSessionStart(), McpServerManager, prepareMcpSession() (+63 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (101): deriveLocalPluginName(), installPluginInteractivity(), isPathEntry(), loadAndInstallPlugins(), loadLocalPluginModule(), loadPlugins(), synthesizeErrorResult(), createClackSdk() (+93 more)

### Community 7 - "Community 7"
Cohesion: 0.03
Nodes (94): formatOwnerNotification(), handleAutoExecuteActions(), handlePostToAutoExecute(), triggerFollowUp(), applyConfigUpdateIntent(), setupDmDelivery(), buildAnswerBlocks(), confirmInDm() (+86 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (35): makeActiveChange(), makeCtx(), buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus() (+27 more)

### Community 9 - "Community 9"
Cohesion: 0.04
Nodes (28): buildTestTasks(), cleanup(), main(), parallel(), readTestConfig(), runFullPathTest(), setup(), validateFinalState() (+20 more)
...
Cohesion: 0.09
Nodes (12): makeClient(), makeParams(), handleMessageChanged(), resolveRestartText(), getByThread(), getForChannelMessage(), makeThreadKey(), register() (+4 more)
...
Cohesion: 0.2
Nodes (2): askClaudeAdapter(), fakeHandleFromResponse()
...
- **Thin community `Community 34`** (11 nodes): `askClaudeAdapter()`, `fakeHandleFromResponse()`, `getPostMessageMock()`, `makeClaudeOptions()`, `makeClient()`, `makeDeps()`, `makeSession()`, `makeSessionInfo()`, `resetStreamerInstance()`, `waitForReactionAddCalls()`, `handlerResponse.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `t()` connect `Community 7` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 12`, `Community 19`?**
  _High betweenness centrality (0.013) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 6` to `Community 0`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 11`, `Community 14`, `Community 15`, `Community 19`?**
