...
## Corpus Check
- 804 files · ~2,081,560 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3740 nodes · 7986 edges · 168 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1280 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (150): makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer(), assembleChoiceVoters(), makeDeps(), installClickableVoteHandler() (+142 more)
...
Cohesion: 0.01
Nodes (187): formatOwnerNotification(), detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), isChangesEnabledForTrigger(), isRecoveryCommand(), SilentDelivery, StreamingDelivery (+179 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (193): truncate(), loadConfig(), executeChange(), readBranchHead(), resolveChangesInstructions(), runClaude(), runClaudeInWorktree(), runWorktreeInstall() (+185 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (60): checkSessionCompletion(), cleanupSession(), runCompletionCheck(), runIdleSweep(), makeDeps(), makeMockPool(), poolWorkerForChange(), fetchPRReviewContext() (+52 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (96): buildIntegrationsCatalog(), attentionLevelGuidance(), buildDeliveryContext(), buildPrompt(), formatThreadContext(), latestUserText(), messageClaimsAdmin(), renderAdminClaimContext() (+88 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (72): enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), call(), clientWithReplies(), makeClient(), makeConfig() (+64 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (36): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), cleanupStaleSessionFolders(), createSessionFolder() (+28 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (49): buildHintModal(), resolveFallbackTopics(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin() (+41 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (43): makeHangingRun(), askClaude(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory(), recordTraceEntry() (+35 more)
...
Cohesion: 0.04
Nodes (48): textResult(), convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), recordError() (+40 more)
...
Cohesion: 0.07
Nodes (16): fetchAssistantContext(), resolveContextChannelId(), makeDeps(), makeStopDeps(), MockAssistant, extractThreadInfo(), keyFor(), PerThreadContextStore (+8 more)
...
- **Thin community `Community 35`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 1` to `Community 0`, `Community 5`, `Community 6`, `Community 8`, `Community 11`, `Community 18`, `Community 24`, `Community 25`?**
  _High betweenness centrality (0.021) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 8`, `Community 11`, `Community 19`?**
