...
## Corpus Check
- 890 files · ~2,198,148 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4056 nodes · 8658 edges · 174 communities detected
...
Cohesion: 0.01
Nodes (192): createRemoveCheatTool(), createRetrieveScoresTool(), createSaveCheatingTool(), makeFakeSdk(), assembleBooleanVoters(), makeDeps(), buildExcludeSet(), isScoredAnswer() (+184 more)

### Community 1 - "Community 1"
Cohesion: 0.01
Nodes (263): loadConfig(), isValidBranchName(), detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), drainStagedSpinoffs(), executeChange(), readBranchHead() (+255 more)

### Community 2 - "Community 2"
Cohesion: 0.01
Nodes (171): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), makeCtx() (+163 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (108): isChangesEnabledForTrigger(), convertMarkdownToSlack(), splitForSlack(), buildIntegrationsCatalog(), attentionLevelGuidance(), buildDeliveryContext(), buildPrompt(), directPostThreadHint() (+100 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (83): fetchAssistantContext(), resolveContextChannelId(), makeDeps(), makeStopDeps(), MockAssistant, enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext() (+75 more)

### Community 5 - "Community 5"
Cohesion: 0.03
Nodes (104): formatOwnerNotification(), truncate(), buildHintModal(), extractToolErrorMessage(), buildRosterBlock(), groupRosterAnswers(), renderHidden(), handleAutoExecuteActions() (+96 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (86): ClaudeMessageParser, detectPlatformError(), joinContentBlocks(), stringifyToolResultContent(), asNumber(), readResultUsage(), appendAttachHistory(), makeCtx() (+78 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (63): resolveFallbackTopics(), textResult(), buildCronExpression(), computeTicks(), rateLabel(), rateToDieFromTicks(), resolveDie(), casualTalkPlugin() (+55 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (57): seedJob(), reconcileMemoryReviewCron(), reviewJobExists(), actorDisplay(), actorDmTarget(), resolveJobActor(), getCronMaxRunHistory(), circularRuns() (+49 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (21): buildChangeSessionForPersistence(), clearActiveChange(), getActiveChange(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool() (+13 more)
...
Cohesion: 0.03
Nodes (27): makeHangingRun(), makeRunFromMessages(), buildPolicyBlock(), formatElapsedSeconds(), formatRelativeAge(), runActiveRunPreAnalysis(), runPreAnalysis(), captureSystemPrompt() (+19 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (46): readRepoSkillBody(), discoverWorkerSkills(), getWorkerSkillMtimeMs(), listSlugs(), readDescription(), readWorkerSkillBody(), resolveSkillPath(), skillsRoots() (+38 more)

### Community 15 - "Community 15"
Cohesion: 0.04
Nodes (40): defaultListPulls(), defaultGraphql(), getAuthenticatedCloneUrl(), getCredentials(), getInstallationToken(), getOctokit(), getPrivateKey(), gitHubCredentialsExist() (+32 more)
...
Cohesion: 0.4
Nodes (4): resetSkillPluginsDeps(), P(), resetMocks(), setupTwoPlugins()
...
- **Thin community `Community 32`** (13 nodes): `loadKey()`, `SkillsManager`, `.catalog()`, `.constructor()`, `.getSkill()`, `.isEagerPack()`, `.isSkillLoaded()`, `.knownLazyPackNames()`, `.knowsLazyPack()`, `.listSkills()`, `.markLoaded()`, `.packDescription()`, `.readSkillBody()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 40`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 2` to `Community 0`, `Community 3`, `Community 7`, `Community 9`, `Community 17`, `Community 25`, `Community 26`, `Community 31`?**
  _High betweenness centrality (0.024) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 5` to `Community 0`, `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 24`?**
  _High betweenness centrality (0.012) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 1` to `Community 2`, `Community 35`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 10`, `Community 14`, `Community 15`, `Community 19`, `Community 23`?**
