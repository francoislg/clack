...
## Corpus Check
- 849 files · ~2,140,077 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 3896 nodes · 8332 edges · 179 communities detected
...
Cohesion: 0.01
Nodes (155): createAddAutoRespondRuleTool(), createCancelReminderTool(), createCancelScheduledMessageTool(), createCancelWorkerRunTool(), createCreateScheduledMessageTool(), createDeleteAutoRespondRuleTool(), createProposeChangeTool(), createProposeConfigUpdateTool() (+147 more)

### Community 3 - "Community 3"
Cohesion: 0.02
Nodes (111): detectFollowUpCommand(), drainStagedSpinoffs(), executeChange(), resolveChangesInstructions(), runClaudeInWorktree(), runWorktreeInstall(), runWorktreeSetup(), defaultGetReusablePool() (+103 more)

### Community 4 - "Community 4"
Cohesion: 0.02
Nodes (123): formatOwnerNotification(), truncate(), buildHintModal(), runClaude(), ClaudeMessageParser, detectPlatformError(), extractToolErrorMessage(), joinContentBlocks() (+115 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (91): convertMarkdownToSlack(), splitForSlack(), buildIntegrationsCatalog(), attentionLevelGuidance(), buildDeliveryContext(), buildPrompt(), formatThreadContext(), latestUserText() (+83 more)

### Community 6 - "Community 6"
Cohesion: 0.03
Nodes (77): seedJob(), enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext(), respond(), processMessage(), startThreadConversation(), fetchViaHistory() (+69 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (47): createFindSubjectTool(), run(), commonsImageSearchPlugin(), extractExtMetadata(), fetchImageBytes(), fetchImageInfo(), fetchPageSummary(), fetchWithTimeout() (+39 more)

### Community 8 - "Community 8"
Cohesion: 0.03
Nodes (27): makeHangingRun(), createPushableAsyncIterable(), captureSessionId(), clackSession(), makeUserMessage(), createRunHandle(), makeDriver(), call() (+19 more)
...
Cohesion: 0.04
Nodes (61): loadConfig(), askClaude(), prepareMcpSession(), clackQuery(), testMCP(), analyzeError(), detectRuntime(), summarizeForSlack() (+53 more)
...
Cohesion: 0.04
Nodes (49): clearActiveChange(), getActiveChange(), callTool(), getSession(), readFile(), cacheFile(), extensionForMime(), filePath() (+41 more)

### Community 14 - "Community 14"
Cohesion: 0.05
Nodes (46): discoverWorkerSkills(), getWorkerSkillMtimeMs(), listSlugs(), readDescription(), readWorkerSkillBody(), resolveSkillPath(), skillsRoots(), getWorkerSkillBody() (+38 more)
...
Cohesion: 0.12
Nodes (2): createEmojiCache(), createUsersCache()
...
- **Thin community `Community 28`** (16 nodes): `makeCtx()`, `makeUsersCache()`, `resetMocks()`, `createEmojiCache()`, `resolveAlias()`, `createUsersCache()`, `isRealUser()`, `makeClient()`, `toUserEntry()`, `buildWildcardMatcher()`, `emojiCache.ts`, `usersCache.test.ts`, `usersCache.ts`, `wildcardMatcher.test.ts`, `wildcardMatcher.ts`, `findUser.test.ts`
...
- **Thin community `Community 34`** (12 nodes): `detachStub()`, `failingRelease()`, `makeActiveChange()`, `makeDeps()`, `makeFakeHandle()`, `makeMockPool()`, `makeSweepPool()`, `makeWorker()`, `makeWorkerRecord()`, `mockRelease()`, `sessionReturning()`, `monitor.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 41`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 45`** (7 nodes): `WorkerQueue`, `.depth()`, `.dequeue()`, `.enqueueAndWait()`, `.findBySession()`, `.list()`, `.removeEntry()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 2` to `Community 0`, `Community 5`, `Community 38`, `Community 7`, `Community 24`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 4` to `Community 0`, `Community 1`, `Community 3`, `Community 5`, `Community 23`?**
  _High betweenness centrality (0.017) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 3` to `Community 1`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 11`, `Community 12`, `Community 13`, `Community 14`, `Community 16`, `Community 19`, `Community 22`?**
