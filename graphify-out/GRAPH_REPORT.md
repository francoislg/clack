...
## Corpus Check
- 892 files · ~2,210,236 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 4065 nodes · 8678 edges · 168 communities detected
- Extraction: 82% EXTRACTED · 16% INFERRED · 0% AMBIGUOUS · INFERRED: 1412 edges (avg confidence: 0.8)
...
Cohesion: 0.01
Nodes (181): isValidBranchName(), resolveNonCollidingBranch(), detectFollowUpCommand(), findChangeEnabledRepo(), getChangeEnabledRepos(), drainStagedSpinoffs(), executeChange(), readBranchHead() (+173 more)

### Community 3 - "Community 3"
Cohesion: 0.01
Nodes (166): formatOwnerNotification(), truncate(), buildHintModal(), isChangesEnabledForTrigger(), extractToolErrorMessage(), NullDelivery, SilentDelivery, StreamingDelivery (+158 more)

### Community 4 - "Community 4"
Cohesion: 0.01
Nodes (92): fetchAssistantContext(), resolveContextChannelId(), makeDeps(), makeStopDeps(), MockAssistant, enrichForPreAnalysis(), fetchEnrichedContext(), resolveAutoRespondContext() (+84 more)

### Community 5 - "Community 5"
Cohesion: 0.02
Nodes (111): loadConfig(), completeSessionStart(), McpServerManager, prepareMcpSession(), clackQuery(), loadConfig(), addMigrationError(), dmAdmin() (+103 more)

### Community 6 - "Community 6"
Cohesion: 0.02
Nodes (103): createRemoveCheatTool(), createRetrieveScoresTool(), createSaveCheatingTool(), installHintButtonHandler(), resolveFallbackTopics(), textResult(), buildCronExpression(), computeTicks() (+95 more)

### Community 7 - "Community 7"
Cohesion: 0.02
Nodes (96): createRunScheduledMessageNowTool(), seedJob(), publishHomeView(), registerAddRoleHandlers(), registerHomeTabHandler(), registerRemoveRoleHandlers(), makeApp(), closeModalIfOpen() (+88 more)

### Community 8 - "Community 8"
Cohesion: 0.02
Nodes (95): clearActiveChange(), getActiveChange(), buildIntegrationsCatalog(), attentionLevelGuidance(), buildDeliveryContext(), buildPrompt(), formatThreadContext(), latestUserText() (+87 more)

### Community 9 - "Community 9"
Cohesion: 0.02
Nodes (40): buildChangeSessionForPersistence(), setActiveChange(), updateActiveChangePrUrl(), updateActiveChangeStatus(), makeDeps(), makeMockPool(), cleanupStaleSessionFolders(), createSessionFolder() (+32 more)

### Community 10 - "Community 10"
Cohesion: 0.03
Nodes (34): makeHangingRun(), makeRunFromMessages(), buildSuccessResponse(), buildToolResults(), handleQueryError(), hasProperty(), optionalHistory(), recordTraceEntry() (+26 more)
...
Cohesion: 0.04
Nodes (47): convertMarkdownToSlack(), splitForSlack(), buildAdditionalMessagesField(), buildSubmitResponseSchema(), buildThreadRepliesField(), createSubmitResponseTool(), callTool(), callToolRaw() (+39 more)
...
Cohesion: 0.05
Nodes (36): buildTrackedMemoryKinds(), listTrackedKinds(), namespaceOf(), trackedMemoryKindsForRole(), formatFailure(), zodErrorToResult(), createRecallTool(), archive() (+28 more)
...
- **Thin community `Community 36`** (8 nodes): `makeCtx()`, `makeDeps()`, `makePR()`, `makeRepo()`, `prInput()`, `returning()`, `throwing()`, `findPullRequests.test.ts`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `tool()` connect `Community 6` to `Community 0`, `Community 1`, `Community 4`, `Community 7`, `Community 8`, `Community 13`, `Community 14`, `Community 16`, `Community 18`, `Community 19`, `Community 23`, `Community 24`?**
  _High betweenness centrality (0.025) - this node is a cross-community bridge._
- **Why does `t()` connect `Community 3` to `Community 0`, `Community 2`, `Community 4`, `Community 5`, `Community 7`, `Community 13`?**
  _High betweenness centrality (0.015) - this node is a cross-community bridge._
- **Why does `resolve()` connect `Community 2` to `Community 32`, `Community 1`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 14`, `Community 16`, `Community 22`?**
