...
- **AND** `{repo-name}_changes_instructions.md` resolves via the two-tier chain
...
- **GIVEN** a repository named `{repo-name}` is configured
- **AND** `{repo-name}_changes_instructions.md` does not exist in either tier
- **WHEN** a change is executed for that repository
...
- **GIVEN** `{repo-name}_changes_instructions.md` resolves for a repository
...
- **GIVEN** a repository named `{repo-name}` is configured
- **AND** `{repo-name}_worktree_setup_instructions.md` resolves via the two-tier chain
...
- **GIVEN** a repository named `{repo-name}` is configured
- **AND** `{repo-name}_worktree_setup_instructions.md` does not exist in either tier
