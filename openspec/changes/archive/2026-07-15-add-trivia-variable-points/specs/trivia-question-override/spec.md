...
A narrow admin reclass tool, `override_question`, for retroactively correcting stamped question values that no existing machinery can re-derive (Claude-picked at generation, not cascade-derivable). Explicitly NOT a question editor.
