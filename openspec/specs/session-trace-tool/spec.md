# session-trace-tool Specification

## Purpose
Admin-only MCP tool to retrieve the full SDK conversation trace (messages, tool calls, results) for any Clack session, enabling cross-session debugging.
