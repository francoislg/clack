# slack-channel-resolver Specification

## Purpose
Shared channel resolution helpers for tools that accept channel-like identifiers (names, IDs, or user IDs), normalizing inputs to canonical Slack channel IDs with DM support and security boundaries for user-ID inputs.
