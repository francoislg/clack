...
Enable users to recover from failed changes through three recovery actions (Continue, Start Over, Discard) posted as buttons on the failure message, with strict permission gating and concurrency guards.
