# github-mcp-auto-config Specification

## Purpose

Automatic configuration of the GitHub MCP server from GitHub App credentials. Derives toolsets from installation token permissions and provides fresh tokens per query session.
