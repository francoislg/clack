# link-unfurl-control Specification

## Purpose
System-wide control over Slack link and media unfurling on outgoing Clack messages, with a shared helper and per-call opt-in via `suppressUnfurls: boolean`.
