...
- **THEN** the Slack UI renders a primary-styled button (default label: "Start Change")
...
- **THEN** the Slack UI renders a primary-styled button for merging the PR
...
- **THEN** the Slack UI renders a danger-styled button for closing the PR
