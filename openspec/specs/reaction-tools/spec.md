# reaction-tools Specification

## Purpose
Query tools for adding and removing emoji reactions to Slack messages. Provides direct Slack reaction API access from Claude during query sessions.
