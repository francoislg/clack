# coverart-image-search Specification

## Purpose
Keyless album-cover MCP tool for visual trivia: `find_album` resolves a query through MusicBrainz release-group search and the Cover Art Archive, returning the front cover as a data-mode multimodal result with structured errors, `coverart:rg-<mbid>` subjectId namespacing, and MusicBrainz/CAA etiquette.
## Requirements
