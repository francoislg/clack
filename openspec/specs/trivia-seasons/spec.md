...
#### Scenario: Slug uniqueness is enforced (upsert with existing slug is an UPDATE)
...
- **WHEN** `upsert_season("marine-2026-06", <June 1>, <June 30>, categories: ["Cephalopods", "Cephalopods", "Tides"])` is called
