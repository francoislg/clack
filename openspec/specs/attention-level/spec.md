# attention-level Specification

## Purpose
Per-conversation attention dial that controls Clack's engagement level for auto-respond tracking, allowing admins and users to tune thread responsiveness across four rungs plus off.
