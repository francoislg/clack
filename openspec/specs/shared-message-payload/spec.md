# shared-message-payload Specification

## Purpose

Define a single reusable message-payload entity schema that represents "a Slack message Claude can deliver," used across all delivery surfaces (primary bound-channel, post_to actions, deliver_to entries) to eliminate per-surface duplication.
