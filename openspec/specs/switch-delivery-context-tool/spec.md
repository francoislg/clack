# switch-delivery-context-tool Specification

## Purpose

Expose an MCP tool that allows Claude to switch between streaming and silent delivery modes mid-turn, enabling dynamic adaptation of the response UX without waiting for the next turn.
