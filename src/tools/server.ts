...
import { createDescribeEmojiTool } from "./query/describeEmoji.js";
...
function buildQueryTools(ctx: QueryToolContext): ClackQueryToolsResult {
  ...
  if (ctx.slackClient) {
    ...
    tools.push(createDescribeEmojiTool(emojiCache));
    tools.push(createFetchSlackMessageTool(ctx, undefined, emojiCache));
    tools.push(createFetchChannelMessagesTool(ctx, undefined, emojiCache));
