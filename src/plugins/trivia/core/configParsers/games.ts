...
export function parseTriviaGame(
  ...
  let disableAfterRound: boolean | undefined;
  if (e.disableAfterRound !== undefined && e.disableAfterRound !== null) {
    if (typeof e.disableAfterRound !== "boolean") {
      issues.push({
        field: `${fieldPrefix}.disableAfterRound`,
        error: `must be a boolean (got ${typeof e.disableAfterRound})`,
      });
    } else {
      disableAfterRound = e.disableAfterRound;
    }
  }

  let remindMissedPlayers: boolean | undefined;
  if (e.remindMissedPlayers !== undefined && e.remindMissedPlayers !== null) {
    if (typeof e.remindMissedPlayers !== "boolean") {
      issues.push({
        field: `${fieldPrefix}.remindMissedPlayers`,
        error: `must be a boolean (got ${typeof e.remindMissedPlayers})`,
      });
    } else {
      remindMissedPlayers = e.remindMissedPlayers;
    }
  }
  ...
  if (e.points !== undefined && e.points !== null) {
    const r = validateTriviaPoints(e.points, `${fieldPrefix}.points`);
    if (r.ok) points = r.value;
  ...
  return {
    game: {
      ...
      ...(disableAfterRound !== undefined ? { disableAfterRound } : {}),
      ...(remindMissedPlayers !== undefined ? { remindMissedPlayers } : {}),
